								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											{{-- <a class="badge badge-pill badge-warning mr-auto my-auto float-left" href="{{ url('read_all') }}"><span>تحديد كمقروءة</span></a> --}}
										</div>
										@php
											$countNot=Auth::user()->unreadNotifications->count()
										@endphp
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">الأشعارات الغير مقروءة : {{ $countNot }}</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										@foreach (Auth::user()->unreadNotifications as $Notification)
										<a class="d-flex p-3 border-bottom" href="{{ url('details') }}/{{ $Notification->data['invoice_id'] }}">
									...
									@if($countNot >= 5)
										<div class="dropdown-footer">
											<a href="{{ url('all_notification') }}">Veiw All</a>
										</div>
										@endif
									</div>
								</div>
