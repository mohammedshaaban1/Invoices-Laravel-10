...
@endsection
@section('title')
    تغير حالة الدفع - برنامج ادارة الفواتير
@stop
@section('page-header')
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('update_status') }}/{{ $invoice->id }}" method="post" autocomplete="off">
                        {{ method_field('PATCH') }}
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="payment_Date" placeholder="YYYY-MM-DD" type="text" required value="{{ date('Y-m-d') }}">
                            </div>
                        </div><br>
