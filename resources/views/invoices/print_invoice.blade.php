...
@endsection
@section('title')
طباعة فاتورة - برنامج ادارة الفواتير
@stop
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            {{-- <div class="billed-from">
                                <h6>#</h6>
                                <p>#<br>
                                    Tel No: 000 000-0000<br>
                                    Email: invoices.management.mvr@gmail.com</p>
                            </div><!-- billed-from --> --}}
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                {{-- <label class="tx-gray-600">مرسل الي</label> --}}
                                <div class="billed-to">
                                    <h4>برنامج ادارة الفواتير</h4>
                                    <p>وسائل التواصل<br>
                                        Tel No: 999 999-9999<br>
                                        Email: invoices.management.mvr@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md">
